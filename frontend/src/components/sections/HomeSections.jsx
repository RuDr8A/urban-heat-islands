// create new file in src/compo/sections called HomeSections.jsx
...
function FeatureCard({ number, title, text }) {
  return (
    <div className="group rounded-3xl border border-white/10 bg-white/[0.035] p-6 hover:bg-white/[0.055] hover:border-white/20 transition-all duration-300">
      <div className="text-sm font-mono text-orange-300/70 mb-5">{number}</div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="max-w-3xl mb-12">
            ...
            <p className="mt-6 text-white/50 leading-relaxed max-w-2xl">
              Urban Heat Intelligence combines land-surface temperature with
              environmental and geographic indicators to understand how
              different parts of a city experience surface heat.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6">
              ...
              <div className="text-sm text-white/40 mt-2">Indian cities</div>
            </div>

            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6">
              <div className="text-3xl font-semibold text-white">5</div>

              <div className="text-sm text-white/40 mt-2">Analysis years</div>
            </div>

            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6">
              <div className="text-3xl font-semibold text-white">7</div>

              <div className="text-sm text-white/40 mt-2">ML features</div>
            </div>

            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6">
              <div className="text-3xl font-semibold text-white">LST</div>

              <div className="text-sm text-white/40 mt-2">Target variable</div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 md:items-center md:justify-between">
              <div>
                ...
                <p className="text-sm text-white/40 mt-2 max-w-2xl leading-relaxed">
                  Latitude, longitude, city and year allow the system to connect
                  environmental conditions with their geographic and temporal
                  context.
                </p>
              </div>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="max-w-3xl mb-14">
            ...
            <p className="mt-6 text-white/50 leading-relaxed max-w-2xl">
              The system combines environmental data processing, machine
              learning, spatial analysis and explainable AI into a single
              workflow.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="rounded-3xl border border-orange-300/15 bg-orange-300/[0.035] p-7">
              ...
              <p className="text-white/45 leading-relaxed mb-8">
                For an individual location, SHAP explains how each environmental
                feature contributed to the model's prediction relative to its
                baseline.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/10 p-5">
                  ...
                  <p className="text-sm text-white/40 mt-1">
                    The explanation changes with the environmental conditions at
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="max-w-3xl mb-14">
            ...
            <p className="mt-6 text-white/50 leading-relaxed max-w-2xl">
              Urban Heat Intelligence is a hackathon prototype focused on
              turning complex environmental and spatial data into information
              that can be explored, understood and acted upon.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-7">
              ...
              <p className="text-white/45 leading-relaxed">
                Instead of presenting temperature as a collection of isolated
                numbers, the platform connects environmental conditions,
                machine-learning predictions and geographic patterns in one
                interface.
              </p>
            </div>
