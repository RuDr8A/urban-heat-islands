    ...
    click: async (e) => {
      ...
      try {
        ...
        if (data && data.address) {
          placeName = data.address.city || data.address.town || data.address.county || data.address.state || "Custom Location";
        }
...
export default function GlobalMapExplorer({ setActiveView }) {
